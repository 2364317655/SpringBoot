...
@MapperScan(basePackages="com.yd.test02",sqlSessionFactoryRef="test2SqlSessionFactory")
public class DataSource2Config {
	...
	*//**
	 ...
	 * @return
	 *//*
	@Bean(name="test2TransavtionManager")
	public DataSourceTransactionManager testTransavtionManager(@Qualifier("test2DataSource")DataSource dataSource){
